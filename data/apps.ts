...
export const apps: App[] = [
  ...
  // ── 인공지능 기초 실험실 ─────────────────────────────────────────
  // 초급·중급·고급 세 가지 학습 방식을 골라 시작할 수 있는 실험형 앱 묶음입니다.
  {
    id: '데이터-구조대_-품질과-편향-실험실',
    name: '데이터 구조대: 품질과 편향 실험실',
    description:
      '같은 인공지능도 어떤 데이터로 배우느냐에 따라 판단이 달라집니다. 결측치와 이상값, 불균형을 직접 고쳐 보며 성능과 공정성이 어떻게 변하는지 관찰합니다.',
    badge: 'new',
    category: '인공지능기초',
    menuId: 'ai-unit-2-1',
    buttonText: '시작하기',
  },
  {
    ...
    name: 'AI 길찾기 연구소',
    description:
      '같은 미로를 깊이 우선, 너비 우선, 최상 우선, A*로 각각 풀어 보며 탐색 순서와 방문 노드 수, 경로 비용이 어떻게 달라지는지 비교합니다.',
    badge: 'new',
    category: '인공지능기초',
    menuId: 'ai-unit-1-2',
    buttonText: '시작하기',
  ...
  {
    id: '두뇌-방식-대결_-규칙-vs-학습',
    name: '두뇌 방식 대결: 규칙 vs 학습',
    description:
      '똑같은 분류 문제를 규칙 기반 추론과 학습 기반 모델로 각각 풀어 보고, 설명 가능성과 예외 대응, 새 사례 적응력을 비교합니다.',
    badge: 'new',
    category: '인공지능기초',
    menuId: 'ai-unit-1-2',
    buttonText: '시작하기',
  ...
  {
    id: '나무가-판단하는-법_-의사결정나무-설계자',
    name: '나무가 판단하는 법: 의사결정나무 설계자',
    description:
      '질문을 순서대로 배치해 분류 규칙을 직접 만들고, 나무의 깊이와 분기 기준이 정확도와 과적합에 어떤 영향을 주는지 확인합니다.',
    badge: 'new',
    category: '인공지능기초',
    menuId: 'ai-unit-2-1',
    buttonText: '시작하기',
  ...
  {
    id: '추천의-거울_-취향과-필터-버블',
    name: '추천의 거울: 취향과 필터 버블',
    description:
      '콘텐츠를 평가하고 추천 방식을 바꿔 가며 결과가 어떻게 달라지는지 살펴봅니다. 정확도뿐 아니라 다양성과 필터 버블까지 함께 다룹니다.',
    badge: 'new',
    category: '인공지능기초',
    menuId: 'ai-unit-2-1',
    buttonText: '시작하기',
  ...
  {
    id: '모델-올림픽_-회귀-분류-군집',
    name: '모델 올림픽: 회귀·분류·군집',
    description:
      '문제를 보고 회귀인지 분류인지 군집인지 판단하고, 목표값과 평가 지표에 맞는 모델을 골라 기준 모델과 겨루게 합니다.',
    badge: 'new',
    category: '인공지능기초',
    menuId: 'ai-unit-2-1',
    buttonText: '시작하기',
  },
  {
    ...
    name: '뉴런 조율사: 가중치와 편향',
    description:
      '인공 뉴런 하나의 가중치와 편향을 직접 조절해 결정 경계를 움직여 봅니다. 학습이 오차를 줄이는 과정임을 관찰하고 단층 모델의 한계까지 확인합니다.',
    badge: 'new',
    category: '인공지능기초',
    menuId: 'ai-unit-2-2',
    buttonText: '시작하기',
  },
  {
    ...
    name: 'AI 시민 배심원',
    description:
      '가상의 인공지능 도입 사례를 이해관계자, 증거, 원칙, 책임의 관점에서 검토합니다. 점수를 매기지 않고 근거의 충실도로 되돌아보는 숙의형 활동입니다.',
    badge: 'new',
    category: '인공지능기초',
    menuId: 'ai-unit-3-2',
    buttonText: '시작하기',
