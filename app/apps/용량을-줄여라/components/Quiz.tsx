          ...
          <div className="mt-8 flex justify-end">
            {!isAnswered ? (
              <button
                ...
                className="px-6 py-3 bg-indigo-600 text-white rounded-lg font-medium hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-sm"
              >
                정답 확인하기
              </button>
            ) : (
              currentQIndex < QUIZ_QUESTIONS.length - 1 ? (
                ...
                <div className="text-indigo-600 font-bold">모든 문제를 풀었습니다!</div>
              )
            )}
          </div>
        </div>
