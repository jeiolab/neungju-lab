...
export const Concepts: React.FC = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="md:col-span-2 bg-indigo-600 rounded-2xl p-8 text-white shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-indigo-700/50 p-4 rounded-xl backdrop-blur-sm">
            <Database className="w-8 h-8 mb-3 text-indigo-300" />
            <h3 className="font-bold mb-2">저장 공간 절약</h3>
            <p className="text-sm text-indigo-200">더 많은 사진과 영상을 같은 용량의 하드디스크에 저장할 수 있습니다.</p>
          </div>
          <div className="bg-indigo-700/50 p-4 rounded-xl backdrop-blur-sm">
            <Zap className="w-8 h-8 mb-3 text-yellow-300" />
            <h3 className="font-bold mb-2">전송 속도 향상</h3>
            <p className="text-sm text-indigo-200">파일 크기가 작을수록 인터넷으로 전송하는 시간이 획기적으로 줄어듭니다.</p>
          </div>
          <div className="bg-indigo-700/50 p-4 rounded-xl backdrop-blur-sm">
            <PiggyBank className="w-8 h-8 mb-3 text-green-300" />
            <h3 className="font-bold mb-2">비용 절감</h3>
            <p className="text-sm text-indigo-200">데이터 센터 유지 비용과 네트워크 사용 요금을 아낄 수 있습니다.</p>
          </div>
        </div>
      </div>
      ...
      <div className="md:col-span-2 bg-slate-900 rounded-2xl p-6 text-white flex items-center justify-between shadow-lg">
        <div>
           <h3 className="font-bold text-lg mb-1 flex items-center gap-2">
             <Scale className="w-5 h-5 text-slate-400" /> 트레이드 오프 (Trade-off)
           </h3>
