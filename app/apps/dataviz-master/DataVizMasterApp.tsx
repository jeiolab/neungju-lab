...
const DataVizMasterApp: React.FC = () => {
    ...
    <div className="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden bg-background-light">
      ...
      <main className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12 flex-grow">
        <div className="min-h-screen flex flex-col font-sans">
          {/* Internal Header */}
          <header className="bg-white border-b border-slate-200 mb-8 rounded-lg shadow-sm">
            <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
              <div className="flex items-center gap-2">
                <div className="bg-indigo-600 p-2 rounded-lg text-white">
                  <BarChart size={24} />
                </div>
                <h1 className="text-2xl font-bold text-slate-800">차트의 신</h1>
              </div>
          ...
          <div className="flex-grow max-w-6xl mx-auto w-full px-4 pb-8">
...
export default DataVizMasterApp;
