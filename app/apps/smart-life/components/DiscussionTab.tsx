    ...
    <div className="max-w-3xl mx-auto animate-fade-in">
      <div className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden mb-8">
        <div className="bg-white border-b border-slate-200 p-8 text-center">
          ...
          <h2 className="text-2xl font-bold mb-2 text-slate-900">생각해볼 문제</h2>
          <p className="text-slate-600">
            &ldquo;만약 오늘 하루 인터넷이 완전히 끊긴다면,<br/>나의 하루는 어떻게 변할까요?&rdquo;
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 bg-gray-50 border-b">
          ...
          <div className="flex gap-2">
            ...
            <button
              type="submit"
              className="bg-blue-600 text-white px-6 py-3 rounded-xl font-bold hover:bg-blue-700 transition-colors flex items-center gap-2 shadow-md hover:shadow-lg disabled:opacity-50"
              disabled={!input.trim()}
            >
