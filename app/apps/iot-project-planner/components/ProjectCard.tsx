...
export const ProjectCard: React.FC<ProjectCardProps> = ({ data }) => {
  return (
    <div id="project-card" className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden max-w-lg mx-auto transform transition-all hover:scale-[1.01]">
      <div className="bg-blue-600 px-6 py-5">
        ...
        <p className="text-blue-100 text-sm mt-1">Created by {data.studentName || '학생 개발자'}</p>
      </div>
      ...
      <div className="p-6 space-y-5">
        ...
        {/* Logic Flow */}
        <div className="bg-blue-50 rounded-lg p-3 border border-blue-100 flex items-center justify-center space-x-2 text-sm text-blue-800 font-medium">
            <span>감지</span>
