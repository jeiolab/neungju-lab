    ...
    return (
      <div className="flex flex-col items-center justify-center h-full min-h-[500px] text-center p-6 animate-fade-in">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-xl border border-blue-100 w-full max-w-md">
          ...
          <div className="inline-block px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-full font-bold text-lg mb-6">
            {getRankTitle(score)}
          </div>
          ...
          <button 
            onClick={resetGame}
            className="w-full flex items-center justify-center space-x-2 py-3 bg-gray-900 text-white rounded-xl hover:bg-gray-800 transition-colors"
          >
            <RotateCcw size={20} />
            <span>다시 도전하기</span>
          </button>
