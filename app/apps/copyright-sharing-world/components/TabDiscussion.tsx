...
const TabDiscussion: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <section className="bg-white border border-slate-200 text-slate-900 p-8 rounded-2xl shadow-md text-center">
        ...
        {!hasVoted ? (
          ...
          <div className="text-blue-600 font-bold animate-fade-in">
            투표에 참여해주셔서 감사합니다!
          </div>
        )}
      </section>
