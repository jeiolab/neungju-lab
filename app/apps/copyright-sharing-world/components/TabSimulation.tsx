...
const TabSimulation: React.FC = () => {
  ...
  if (gameFinished) {
    return (
      <div className="bg-white rounded-2xl shadow-xl p-8 text-center max-w-2xl mx-auto border-t-8 border-blue-600">
        <div className="mb-6">
          <Gavel className="w-20 h-20 mx-auto text-blue-600 mb-4" />
          ...
          {isJudgeMode ? (
            <div className="flex gap-4 justify-center mt-8">
              ...
              <div className="relative flex items-center justify-center w-20">
                 <Gavel 
                  size={48} 
                  className={`text-slate-300 ${animation ? 'gavel-animation text-blue-600' : ''}`} 
                 />
              </div>
            ...
            <div className="animate-fade-in mt-8">
               ...
               <div className="bg-slate-50 border border-slate-200 text-slate-900 p-6 rounded-xl mb-6">
               ...
               <div className="text-right">
                 <button 
                  ...
                  className="bg-blue-600 text-white px-6 py-3 rounded-lg font-bold hover:bg-blue-700 inline-flex items-center gap-2 shadow-lg"
                 >
                   다음 사건으로
                   <ArrowRight size={18} />
                 </button>
