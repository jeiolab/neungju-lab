...
const DeepDiveTab: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto animate-fade-in pb-10">
      ...
      {/* Balance Section */}
      <div className="mt-12 bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl p-8 text-white text-center shadow-xl">
        <Scale className="w-12 h-12 mx-auto mb-4 text-blue-200" />
        <h3 className="text-2xl font-bold mb-4">균형 잡힌 시각이 중요해요!</h3>
