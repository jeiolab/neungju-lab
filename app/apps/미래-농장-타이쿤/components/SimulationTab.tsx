    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Farm View */}
          <div className="bg-green-100 rounded-xl p-6 shadow-inner min-h-[250px] relative overflow-hidden border border-green-200">
            ...
            <div className="bg-white p-6 rounded-xl shadow">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <button 
                        ...
                        className={`px-4 py-2 rounded-lg font-bold text-white transition-colors ${isRunning ? 'bg-orange-500 hover:bg-orange-600' : 'bg-green-600 hover:bg-green-700'}`}
                    >
                ...
                <div className="space-y-4">
                    {UPGRADES.map(upgrade => {
                        ...
                        return (
                            <div key={upgrade.id} className={`border rounded-lg p-4 transition-all ${isInstalled ? 'bg-green-50 border-green-200 opacity-70' : 'bg-white border-gray-200 hover:shadow-md'}`}>
