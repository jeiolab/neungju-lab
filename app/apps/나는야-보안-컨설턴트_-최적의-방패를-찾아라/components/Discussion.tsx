    ...
    <div className="space-y-8 animate-fade-in max-w-4xl mx-auto">
        <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-2 flex items-center justify-center gap-2">
                <MessageCircle className="text-indigo-600" /> 보안 쟁점 토론
            </h2>
            <p className="text-slate-600">정답이 없는 문제들입니다. 당신의 생각은 어떤가요?</p>
        </div>
        ...
        <div className="bg-white border border-slate-200 shadow-sm p-6 rounded-xl">
            ...
            <div className="bg-amber-50 border border-amber-200 p-4 rounded text-sm text-slate-700 italic mb-4">
            ...
            <textarea 
                ...
                className="w-full bg-white border border-slate-300 text-slate-900 p-3 rounded-lg focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 focus:outline-none h-24"
            ></textarea>
        </div>
        ...
        <div className="bg-white border border-slate-200 shadow-sm p-6 rounded-xl">
            ...
            <div className="bg-red-50 border border-red-200 p-4 rounded text-sm text-slate-700 italic mb-4">
