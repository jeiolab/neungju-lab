    ...
    <div className="space-y-8 animate-fade-in max-w-4xl mx-auto">
        <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-white mb-2 flex items-center justify-center gap-2">
                <MessageCircle className="text-blue-400" /> 보안 쟁점 토론
            </h2>
            <p className="text-slate-400">정답이 없는 문제들입니다. 당신의 생각은 어떤가요?</p>
        </div>

        <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
            <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                <Scale className="text-yellow-400" /> 주제 1: 편리함 vs 보안성
            </h3>
            <p className="text-slate-300 mb-4 leading-relaxed">
                보안이 강력해질수록 사용자는 불편해집니다 (비밀번호 복잡도, 2차 인증, 짧은 세션 시간 등).
                반대로 너무 편리하면 보안은 취약해집니다.
            </p>
            <div className="bg-slate-900 p-4 rounded text-sm text-slate-400 italic mb-4">
        ...
        <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
            <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                <ShieldAlert className="text-red-400" /> 주제 2: 개인정보와 공공의 안전
            </h3>
            <p className="text-slate-300 mb-4 leading-relaxed">
