...
const InputStage: React.FC<InputStageProps> = ({ onSubmit }) => {
  ...
  return (
    <motion.div 
      ...
      className="flex flex-col items-center justify-center w-full max-w-lg p-8 bg-white rounded-xl shadow-sm border border-slate-200"
    >
      ...
      <p className="text-slate-600 mb-8 text-center break-keep">
        알파벳들이 모여있는 숲이에요.<br/>
        어떤 단어를 압축해볼까요?
      </p>
      ...
      <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
        <div className="relative">
          <input
            ...
            className="w-full px-6 py-4 text-xl font-bold text-center text-slate-900 bg-white border-2 border-slate-300 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all uppercase placeholder-slate-400"
          />
          <button 
            type="button" 
