    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-xl font-bold text-white">CEO 핸드북</h2>
        </div>
        ...
        <div className="space-y-4">
          {EDUCATIONAL_CONTENT.map((item, idx) => (
            <div key={idx} className="bg-slate-700/50 p-4 rounded-lg border-l-4 border-indigo-500">
              <h3 className="font-bold text-indigo-200 mb-1">{item.title}</h3>
      ...
      <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 flex flex-col justify-center items-center text-center">
        ...
        <h3 className="text-lg font-bold text-white mb-2">역할 가이드</h3>
