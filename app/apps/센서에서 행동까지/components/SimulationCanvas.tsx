    ...
    <div className="w-full max-w-5xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-100">
      ...
      <div className="p-8 relative min-h-[400px] flex flex-col md:flex-row items-stretch justify-between gap-8 md:gap-4">
        ...
        <div className="flex-1 flex flex-col items-center justify-start space-y-6 z-10">
            <div className="bg-blue-50 border-2 border-blue-200 p-6 rounded-2xl w-full text-center relative shadow-sm h-full">
        ...
        <div className="flex-1 flex flex-col items-center justify-start space-y-6 z-10">
            <div className="bg-purple-50 border-2 border-purple-200 p-6 rounded-2xl w-full text-center relative shadow-sm h-full flex flex-col">
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-purple-600 text-white px-3 py-1 rounded-full text-xs font-bold tracking-wide">
                    2. 처리 (논리)
                </div>
                ...
                <div className="flex-grow flex items-center justify-center w-full">
                    {showCode ? (
                        <div className="bg-slate-800 text-green-400 p-4 rounded-lg font-mono text-sm text-left w-full shadow-inner">
                            <div className="text-slate-500">// 조건 확인</div>
                            <div><span className="text-purple-400">if</span> (센서값 {scenario.logic.operator} {scenario.logic.threshold}) {'{'}</div>
                        ...
                        <div className={`p-4 rounded-xl border-2 transition-all duration-300 ${isActive ? 'bg-green-100 border-green-400' : 'bg-slate-100 border-slate-300'}`}>
                            ...
                            <div className="text-xl font-bold text-slate-800 flex items-center justify-center gap-2">
                                ...
                                <span className="text-purple-600">{scenario.logic.operator}</span>
        ...
        <div className="flex-1 flex flex-col items-center justify-start space-y-6 z-10">
             <div className={`border-2 p-6 rounded-2xl w-full text-center relative shadow-sm h-full flex flex-col transition-colors duration-500 ${isActive ? 'bg-green-50 border-green-200' : 'bg-slate-50 border-slate-200'}`}>
