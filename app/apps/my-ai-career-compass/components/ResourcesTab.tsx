  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div className="text-center py-4">
        <h2 className="text-2xl font-bold text-slate-800">더 알아보기</h2>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 rounded-full bg-blue-500 mt-2"></div>
                <div>
                  <a href="https://www.work.go.kr" target="_blank" rel="noreferrer" className="text-blue-700 font-bold hover:underline">워크넷 (Work.go.kr)</a>
          ...
          <div className="space-y-4">
            <div className="bg-white p-5 rounded-xl shadow-sm border border-slate-100">
              ...
              <p className="text-slate-600 text-sm italic">
                &ldquo;처음엔 코딩이 어렵게만 느껴졌는데, 제가 좋아하는 게임을 직접 만들어보면서 흥미를 느꼈어요. 기술은 도구일 뿐, 중요한 건 무엇을 만들고 싶은가 하는 상상력인 것 같아요.&rdquo;
              </p>
            </div>
            ...
            <div className="bg-white p-5 rounded-xl shadow-sm border border-slate-100">
              ...
              <p className="text-slate-600 text-sm italic">
                &ldquo;그림 그리는 걸 좋아하는데, 요즘은 태블릿으로 그리고 AI로 채색도 해봐요. 전통적인 미술과 기술을 합치니 저만의 스타일이 생기는 것 같아 뿌듯합니다.&rdquo;
              </p>
            </div>
          </div>
        </div>
