  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="text-center space-y-4 py-8">
        <h2 className="text-3xl font-bold text-slate-800">진로 설계, 어떻게 시작할까?</h2>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-8 mt-8 flex flex-col md:flex-row items-center gap-8 shadow-md">
        <div className="flex-1 space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-600 text-white rounded-full text-xs font-bold uppercase">
            핵심 개념
          </div>
          <h3 className="text-2xl font-bold text-slate-900">창직 (Job Creation)이란?</h3>
        ...
        <div className="flex-shrink-0 bg-blue-50 border border-blue-100 p-6 rounded-full">
