...
const appComponents: Record<string, () => Promise<{ default: AppComponent }>> = {
  ...
  '오늘의-ml-미션_-날짜-시드-고정-도전장': () => import('./오늘의-ml-미션_-날짜-시드-고정-도전장/App'),
  ...
  'solomon\'s-choice_-ai-ethics-court': () => import('./solomon\'s-choice_-ai-ethics-court/App'),
  ...
  '에이전트-감별사_-규칙봇-vs-지능봇': () => import('./에이전트-감별사_-규칙봇-vs-지능봇/App'),
  '에이전트-루프-퍼즐': () => import('./에이전트-루프-퍼즐/App'),
  '에이전트-아카데미_-단순-vs-지능': () => import('./에이전트-아카데미_-단순-vs-지능/App'),
  '에이전트-아키텍트': () => import('./에이전트-아키텍트/App'),
  '에이전트-카드덱_-지능-에이전트-마스터리': () => import('./에이전트-카드덱_-지능-에이전트-마스터리/App'),
  '역할-레벨업-카드_-인간×ai-역할-마스터리': () => import('./역할-레벨업-카드_-인간×ai-역할-마스터리/App'),
  '오늘의-공존-미션': () => import('./오늘의-공존-미션/App'),
  '지능-에이전트-마스터': () => import('./지능-에이전트-마스터/App'),
  '진로-에이전트-기획-위저드': () => import('./진로-에이전트-기획-위저드/App'),
