...
const DeepDiveTab: React.FC = () => {
  return (
    <div className="space-y-8 animate-fade-in max-w-4xl mx-auto">
      <div className="bg-space-800 p-8 rounded-xl border border-space-700 shadow-lg relative overflow-hidden">
        ...
        <div className="space-y-6 text-gray-300 leading-relaxed">
          <p>
            ...
            <code className="bg-purple-900/50 text-purple-300 px-2 py-0.5 rounded mx-1">self</code> 
            입니다.
          </p>
          
          <div className="bg-space-900 p-6 rounded-lg border-l-4 border-purple-500">
            <h3 className="text-xl font-bold text-white mb-2">간단 비유: "나 자신"</h3>
            <p>
            ...
            <p className="mt-3">
              이때 "누구의 미사일인지", "누구의 부스터인지"를 명확히 가리키는 손가락이 바로 <code className="text-purple-300">self</code>입니다.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-bold text-white mb-2">코드 없이 생각하기</h4>
              <div className="bg-black/50 p-4 rounded text-sm h-full flex flex-col justify-center">
                <p>"철수야, 밥 먹어." (철수가 먹음)</p>
                <p>"영희야, 밥 먹어." (영희가 먹음)</p>
            ...
            <div>
              <h4 className="font-bold text-white mb-2">코드로 확인하기</h4>
              <pre className="bg-black p-4 rounded text-sm font-mono text-purple-300 h-full">
{`class Suit:
  def attack(self):
