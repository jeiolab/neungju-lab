      ...
      <section className="bg-white rounded-2xl shadow-lg overflow-hidden border border-slate-200">
        <div className="bg-slate-900 text-white p-6">
          <h2 className="text-2xl font-bold flex items-center gap-2">
            <span className="bg-amber-500 text-slate-900 px-2 rounded text-sm">TOOL</span>
            나만의 라이선스 만들기
          </h2>
          <p className="text-slate-400 text-sm mt-1">내가 만든 창작물에 어떤 조건을 붙일지 선택해보세요.</p>
        </div>
        ...
        <div className="p-8 grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-slate-100 rounded-xl p-8 flex flex-col items-center justify-center text-center">
            ...
            <div className="flex gap-2 mb-6">
               ...
               <span className="bg-slate-800 text-white px-2 py-1 rounded text-xs font-bold">BY</span>
               {ccl.nonCommercial && <span className="bg-slate-800 text-white px-2 py-1 rounded text-xs font-bold">NC</span>}
               {ccl.noDerivatives && <span className="bg-slate-800 text-white px-2 py-1 rounded text-xs font-bold">ND</span>}
               {ccl.shareAlike && <span className="bg-slate-800 text-white px-2 py-1 rounded text-xs font-bold">SA</span>}
            </div>
          ...
          {resources.map((site) => (
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <ExternalLink size={14} className="text-slate-400 group-hover:text-amber-500" />
              </div>
