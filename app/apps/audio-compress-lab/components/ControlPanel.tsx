  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 w-full max-w-5xl mx-auto mt-8">
      ...
      <div className="col-span-1 md:col-span-4 bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col justify-between">
        <div>
          <h3 className="text-slate-600 text-sm font-mono uppercase mb-4 flex items-center gap-2">
            ...
            {(['drums', 'piano', 'mix'] as SoundType[]).map((type) => (
              ...
              >
                <div className="flex items-center justify-between">
                   ...
                   {soundType === type && <div className="w-2 h-2 rounded-full bg-blue-600 animate-pulse"></div>}
                </div>
              </button>
            ))}
          </div>
         ...
         <h3 className="text-slate-600 text-sm font-mono uppercase mb-4 flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            ...
            >
              ...
              <div className="text-xs text-slate-400 mt-2 font-mono">20Hz - 20kHz</div>
            ...
            >
              ...
              <div className="text-xs text-slate-400 mt-2 font-mono">16kHz 이상 제거</div>
               {compressionMode === 'mp3' && <div className="absolute top-0 right-0 p-1"><div className="w-2 h-2 bg-blue-600 rounded-full shadow-[0_0_10px_rgba(37,99,235,0.5)]"></div></div>}
            </button>
            ...
            >
              ...
              <div className="text-xs text-slate-400 mt-2 font-mono">3.5kHz 컷 + 마스킹</div>
          ...
          <div className="bg-slate-50 rounded-lg p-4 border border-slate-200 flex flex-wrap items-center justify-between gap-4">
               ...
               <div className="w-full bg-slate-200 rounded-full h-2 overflow-hidden">
                 <div 
                    className={`h-full rounded-full transition-all duration-500 ${
                        ...
                        compressionMode === 'mp3' ? 'bg-blue-600 w-[10%]' : 'bg-amber-500 w-[5%]'
                    }`}
                 ></div>
               </div>
            </div>
            ...
            <button 
                ...
                className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg flex items-center gap-2 transition-colors ml-auto shadow-sm"
            >
