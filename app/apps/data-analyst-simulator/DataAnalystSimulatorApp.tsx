...
const DataAnalystSimulatorApp: React.FC = () => {
          ...
          {phase === Phase.HOME && (
            <div className="flex flex-col items-center justify-center min-h-[80vh] text-center">
              ...
              <button
                ...
                className="bg-primary hover:bg-opacity-90 text-white text-lg font-semibold py-4 px-10 rounded-full shadow-xl transition-transform transform hover:-translate-y-1"
              >
                시뮬레이션 시작
              </button>
              ...
              <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8 text-left max-w-4xl w-full">
                  <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                      ...
                      <p className="text-slate-500 text-sm">웹이나 센서에서 데이터를 수집하기 위한 올바른 도구를 선택하세요.</p>
                  </div>
                  <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                      <h3 className="font-bold text-lg mb-2 text-slate-800">2. 전처리</h3>
                      <p className="text-slate-500 text-sm">결측치, 이상치, 중복과 같은 오류를 찾아 직접 수정하세요.</p>
                  </div>
                  <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                      <h3 className="font-bold text-lg mb-2 text-slate-800">3. 분석</h3>
                      <p className="text-slate-500 text-sm">정제 작업이 AI 데이터 품질 점수를 어떻게 향상시켰는지 확인하세요.</p>
                  </div>
              </div>
            </div>
          )}
...
export default DataAnalystSimulatorApp;
