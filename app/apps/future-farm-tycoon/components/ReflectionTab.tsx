      ...
      <div className="bg-white p-8 rounded-2xl shadow-lg border border-blue-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <textarea
            ...
            className="w-full p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent min-h-[120px] text-gray-700 resize-none"
          />
