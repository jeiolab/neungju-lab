...
const ConceptTab: React.FC = () => {
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="bg-white border border-slate-200 p-8 rounded-2xl shadow-md mt-8 flex flex-col md:flex-row items-center gap-8">
        <div className="flex-1">
          <h3 className="text-2xl font-bold mb-3 text-slate-900">왜 필요할까요?</h3>
        ...
        <div className="w-full md:w-1/3 bg-blue-50 border border-blue-100 p-4 rounded-xl text-center">
            <div className="text-5xl mb-2">📱 + 🐖</div>
            <p className="font-bold text-slate-900">스마트폰으로 농장 관리!</p>
        </div>
      </div>
    </div>
  );
