    ...
    <div className="space-y-8 animate-fade-in">
      <div className="bg-cyber-800 p-6 rounded-2xl border border-cyber-700 shadow-xl">
        <div className="flex justify-between items-center mb-6">
          ...
          <button 
            onClick={randomize}
            className="flex items-center gap-2 px-4 py-2 bg-cyber-700 hover:bg-cyber-600 rounded-lg text-sm transition-colors"
          >
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-cyber-accent font-bold text-xl flex items-center gap-2">
          ...
          <div className="text-cyber-accent font-bold text-xl">
      ...
      <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800">
        <h3 className="text-xl font-bold text-white mb-4">복호화(되돌리기) 확인</h3>
        <p className="text-slate-400 mb-4">
          블록 암호는 반드시 되돌릴 수 있어야 해. **결과(Result)**와 **키(Key)**를 다시 XOR하면, 원래의 **입력값(Input)**이 나와야 하거든.
        </p>
        <button 
          onClick={handleDecryptSimulation}
          className="w-full py-3 bg-cyber-500 hover:bg-cyber-400 text-white font-bold rounded-lg transition-all shadow-[0_0_15px_rgba(59,130,246,0.5)]"
        >
